...
function changeroom(){
	...
	function add(){
		$.post('/room/repair/doadd',$("#form1").serialize(),function(flag){
			if(flag){
				alert("添加成功")
				location="/room/repair/";
			}else{
				alert("该床铺已经有人了")
			}
		})
		...
		<div class="col-3">
			<div class="list-group">
			  ...
			  <a href="/room/repair/" class="list-group-item list-group-item-action">寝室报修</a>
			    <a href="/room/repair/add" class="list-group-item list-group-item-action  active">新增报修</a>
			</div>
		</div>
			    	...
			    	<div>
				    	<form id="form1">
						  ...
						  <div class="form-group">
						    ...
						    <textarea rows="10" class="col-12" name="repair_message"></textarea>
						  </div>
