...
<script type="text/javascript">
	function add(){
		$.post('/room/doadd',$("form").serialize(),function(flag){
			if(flag){
				alert("添加成功")
				location="/room/";
			}
	...
	<div class="row">
		...
		<div class="col-3">
			<div class="list-group">
			  ...
			  <a href="/room/add" class="list-group-item list-group-item-action  active">新增寝室信息</a>
		...
		<div class="col-9">
			    <div class="tab-content" id="content">
					  ...
					  <div class="form-group">
					    ...
					    <input type="text" name="room_size" class="form-control" >
					  </div>
