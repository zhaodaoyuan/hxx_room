	...
	<div class="row">
		...
		<div class="col-3">
			<div class="list-group">
			  ...
			  <a href="/student/" class="list-group-item list-group-item-action active">学生管理</a>
		...
		<div class="col-9">
			    <div class="tab-content" id="content">
			      	<a class="col-1" href="/student/list" style="float: left;">
			      	<img class="img-icon"  src="/public/img/studentlist.jpg" style="width:100%;" >
			      	</br>
			      	<span style="margin:10%;">学生列表</span>
			      	</a>
			      	<a class="col-1" href="/student/add" style="float: left;">
			      	<img class="img-icon" src="/public/img/addstudent.jpg"  style="width: 100%;"  >
			      	</br>
			      	<span style="margin:10%;">新建学生</span>
			      	</a>
  				</div>
		</div>
